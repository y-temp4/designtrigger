...
## 第1条（プライバシー情報）
1. 「本サービス」とは、サービス提供サイトを通じて提供される、「DesignTrigger」という名称のウェブサービスを意味します。
2. 「サービス提供者」とは、本サービスの提供者を意味します。
3. 「サービス利用者」とは、本サービスの利用者を意味します。
4. 「サービス提供サイト」とは、https://designtrigger.com/ 以下のウェブサイトを意味します。
5. 「サービス利用契約」とは、本規約の内容を契約条件に含む、サービス提供者とサービス利用者との間で締結される本サービスの利用契約を意味します。
6. 「サービス利用登録」とは、本サービスを利用する条件である、サービス利用者としての登録を意味します。
7. 「投稿データ」とは、サービス利用者が本サービスを利用して投稿その他の送信をするコンテンツ（文章、画像、動画その他のデータを含みます。）を意味します。
...
2. サービス提供者は、サービス提供者が定める基準に従って、第2項に基づいて登録申請を行った者（以下「登録申請者」といいます。）について登録の可否を判断し、サービス提供者が 登録を認める場合にはその旨を登録申請者に通知します。なお、登録申請者のサービス利用登録は、サービス提供者が本項の通知を行ったことをもって完了します。
3. サービス利用契約は、サービス利用登録の完了をもってサービス提供者とサービス利用者との間で成立します。
...
6. サービス利用者は、登録事項に変更があった場合、サービス提供者の定める方法により変更内容をすみやかにサービス提供者に通知しなければなりません。
...
3. サービス利用者は、投稿データについて、自らが投稿その他の送信をすることについて権利を有していること、及び投稿データが第三者の権利を侵害していないことについて保証するものとします。
4. サービス利用者は、サービス提供者に対し、本サービスの運営、提供及び改善等のために必要な範囲で投稿データを利用する非独占的な権利を無償で許諾するものとします。
5. サービス利用者は、他のサービス利用者に対し、投稿データを本サービスにおいて利用する非独占的な権利を無償で許諾するものとします。
...
## 第13条（連絡・通知の方法）
本サービスに関する問い合わせその他のサービス利用者からサービス提供者に対する連絡または通知は、本サービスが別途指定する方法で行わなければならないものとします。
